      ...
      <div className="flex flex-col md:flex-row min-h-screen bg-cream">
        <div className="w-full md:w-1/2 flex flex-col justify-center items-start px-20 py-25 md:py-0">
          ...
          <div className="flex justify-center">
            <button className="w-40 h-14 flex-1 bg-blue hover:bg-lblue text-cream font-bold rounded-lg mr-4 whitespace-nowrap" href="/#about">
              Learn More ⇣
            </button>
            <button className="w-40 flex-1 bg-cream text-navy font-bold border-4 border-lblue hover:border-lorange border-slate-400 rounded-lg ml-4" href="/signup">
              Sign Up
            </button>
          </div>
        </div>
